    ...
    return (
        <div className="tab-nav">
            <ul>
                ...
                <li className={checkOn("customquotation")}>
                    <Link href="/master/homepage/customquotation">
                        <a>맞춤견적설정</a>
                    </Link>
                </li>
            </ul>
...
export const MemberTopNav = () => {
    return (
        <div className="tab-nav">
            <ul>
                <li className={checkOn("/master/member", true)}>
                ...
                <li className={checkOn("/master/member/partner", true)}>
                    <Link href="/master/member/partner">
                        <a>개인파트너 회원</a>
                    </Link>
                </li>
                <li className={checkOn("signout")}>
                    <Link href="/master/member/signout">
                        <a>탈퇴회원</a>
                    </Link>
                </li>
            </ul>
