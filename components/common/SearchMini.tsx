...
export const SearchMini: React.FC<IProp> = ({ onChange, value }) => {
    return <div className="search_mini">
        <div className="in">
            <input value={value} onChange={(e) => { onChange(e.currentTarget.value) }} type="text" placeholder="검색 내용을 입력해주세요." />
