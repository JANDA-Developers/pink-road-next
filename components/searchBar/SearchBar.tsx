...
export const SearchBar: React.FC<IProp> = ({
    Status,
    SearchSelect,
    onDateChange,
    defaultRange,
    ...
    const check = (should: TDateShortCut): boolean => {
        const checkDay = (start: Date, end: Date) =>
            dayjs(filterStart).isSame(start, "day") &&
            dayjs(filterEnd).isSame(end, "day");
        if (should === "thisMonth") {
        ...
        <div className="search_box">
            ...
            <div className="jul4">
                ...
                <div className="text">
                    <ul className="day_ul">
                        <li
                            className={checkOn("thisMonth")}
                            onClick={setThisMonth}
                        >
                            <span>이번달</span>
                        </li>
                        <li
                            className={checkOn("lastMonth")}
