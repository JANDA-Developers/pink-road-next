...
export const ReviewModal: React.FC<IProp> = ({ info, isOpen, closeModal }) => {
    ...
    const { item: review, getData, prev: prevReview, next: nextReview, loading } = useProductReviewFindById(info?.reviewId, {
        skip: !info?.reviewId
    })
            ...
            <div onClick={(e) => {
                ...
                <div className="popup_bg__review__body">
                    <div className="popup_bg__review_page">
                        <div style={BG(review.files?.[photoIndex]?.uri || "")} className="review__photo">
                        </div>
