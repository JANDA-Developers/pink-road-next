    ...
    return <div className="productSearcher ">
        <div className="write_type">
            ...
            <div className="input_form">
                <input placeholder="검색어를 입력해주세요" autoComplete="off" onKeyPress={whenEnter(getData)} onChange={setVal(setSearch)} value={search} type="text" name="searchbox" className="inputText w100" />
