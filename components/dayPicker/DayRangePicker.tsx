...
`}</style>
            ...
            <div className="info_txt">
                ...
                <ul>
                    ...
                    <li>- 이미지를 첨부시에 이미지 내부에 이미지를 입력할 경우 텍스트를 크게 써주세요. 모바일 화면도 고려해야합니다.</li>
                    <li>- 이미지를 꼭 한번 용량을 압축해서 올려주세요. 로딩시에 시간이 단축됩니다.<a href="https://www.iloveimg.com/ko/compress-image" target="_blank">추천사이트 이동</a></li>
