...
export const PormptModal: React.FC<IProp> = ({
    modalHook,
    className,
    ...props
}) => {
        ...
        >
            <div className={`in_txt`}>
                <div className="page">
                    ...
                    <a onClick={modalHook.closeModal} className="close_icon">
                    ...
                    <div className="con">
                        ...
                        <div className="promptinput__inputWrap">
                            ...
                            />
                            <button
                                className="promptinput__btn btn small"
                                onClick={() => {
                                    callBack?.(submitData);
