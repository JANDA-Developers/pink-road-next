                            ...
                            LeftDiv={
                                <div>
                                    <ul className="board_option">
                                        <li className={checkOnAllForgien()}><a >전체</a></li>
                                        <li onClick={setIsForeginer(false)} className={checkOnForeginer(false)}><a>내국인</a></li>
                                        <li onClick={setIsForeginer(true)} className={checkOnForeginer(true)}><a >외국인</a></li>
                                    </ul>
                                    <ul className="board_option">
                                        <li className={checkOnAllGender()}><a >전체<strong>{totalIndiMemberCount}</strong></a></li>
                                        <li onClick={setGenderFilter(GENDER.MAIL)} className={checkOnGender(GENDER.MAIL)}><a>남</a></li>
                                        <li onClick={setGenderFilter(GENDER.FEMALE)} className={checkOnGender(GENDER.FEMALE)}><a>녀</a></li>
                                    </ul>
                                </div>
                            }
                        />
