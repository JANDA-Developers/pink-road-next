...
export const BoardListBlock: React.FC<IProp> = ({ board }) => {
    const { _id, images, boardType, status, maxMember, adult_price, address, title, contents, thumb, keyWards, createdAt } = board;
    ...
    return <li className="list_in">
        ...
        <div className="textbox__01">
            ...
            <div className="txt">{stripHtml(contents).substr(0, 200)}...</div>
            <div className="tag">
