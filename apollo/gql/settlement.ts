...
export const SETTLEMENT_FIND_BY_ID = gql`
    query settlementFindById($_id: String!) {
        SettlementFindById(_id: $_id) {
            ok
            error {
                location
                severity
...
export const SETTLEMENT_LIST = gql`
    query settlementList(
        ...
        SettlementList(sort: $sort, pageInput: $pageInput, filter: $filter) {
            ok
            error {
                location
                severity
...
export const SETTLEMENT_COMPLETE = gql`
    mutation settlementComplete($settlementId: String!) {
        SettlementComplete(settlementId: $settlementId) {
            ok
            error {
                location
                severity
...
export const SETTLEMENT_REJECT = gql`
    mutation settlementReject($settlementId: String!, $reason: String!) {
        SettlementReject(settlementId: $settlementId, reason: $reason) {
            ok
            error {
                location
                severity
...
export const SETTLEMENT_UPDATE = gql`
    mutation settlementUpdate(
        $settlementId: String!
        $params: SettlementUpdateInput!
    ) {
        SettlementUpdate(settlementId: $settlementId, params: $params) {
            ok
            error {
                location
                severity
