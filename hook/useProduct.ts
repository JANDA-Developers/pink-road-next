...
import {
    ...
    _ProductGroupSort,
    productGroupList,
    productGroupListVariables,
    productGroupList_ProductGroupList_data,
    productGroupFindById,
    productGroupFindByIdVariables,
    productGroupFindById_ProductGroupFindById_data,
} from "../types/api";
...
export const useProductCreate = generateMutationHook<
    productCreate,
    productCreateVariables
>(PRODUCT_CREATE, { ...getRefetch(PRODUCT_LIST) });
...
export const useProductGroupFindById = generateFindQuery<
    productGroupFindById,
    productGroupFindByIdVariables,
    productGroupFindById_ProductGroupFindById_data
>("code", PRODUCT_GROUP_FIND_BY_ID);
...
export const useProductGroupList = generateListQueryHook<
    _ProductGroupFilter,
    _ProductGroupSort,
    productGroupList,
    productGroupListVariables,
    productGroupList_ProductGroupList_data
>(PRODUCT_GROUP_LIST, { initialSort: [_ProductGroupSort.createdAt_desc] });

export const useProductUpdate = (
    options?: MutationHookOptions<productUpdate, productUpdateVariables>
) => {
    const [productUpdateMu, { loading: updateLoading }] = useMutation<
        productUpdate,
...
export const useProductController = (onSucess: () => void, role: UserRole) => {
    ...
    const [productReOpenDeny, { loading: elseDeny_loading }] =
    ...
    const [productElseAccept, { loading: elseAccept_loading }] =
    ...
    const [tarvelDetermine, { loading: determine_loading }] =
        useTravelDetermine({
    ...
    const [travelWithdrwal, { loading: widthrwal_loading }] =
        useTravelWithdrwal({
    ...
    const [rejectUpdate, { loading: updateReject_loading }] =
...
export const useFindProductsByGroup = (groupCode: string) => {
    ...
    return { ...result, dateOrderedItems, productGroupList };
};
