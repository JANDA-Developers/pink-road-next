...
export interface IuseQuestionFindByIdProp
    extends QueryHookOptions<questionFindById, questionFindByIdVariables> {}

export const useQuestionFindById = generateFindQuery<
    questionFindById,
...
export const useQuestionDelete = generateMutationHook<
    questionDelete,
    questionDeleteVariables
>(QUESTION_DELETE, {
    ...getRefetch(PRODUCT_LIST, PRODUCT_FIND_BY_ID, QUESTION_LIST),
});
export const useQuestionUpdate = generateMutationHook<
    questionUpdate,
    questionUpdateVariables
>(QUESTION_UPDAET, {
    ...getRefetch(
