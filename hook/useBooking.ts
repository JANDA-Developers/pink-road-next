import {  BOOKINGS_CREATE,  BOOKING_CANCEL_BYHAND, BOOKING_CANCEL_REJECT, BOOKING_CANCEL_REQ, BOOKING_COMPLETE_BY_HAND, BOOKING_CREATE_BY_HAND, BOOKING_DELETE, BOOKING_FIND_BY_CODE, BOOKING_FIND_BY_INFO, BOOKING_LIST, BOOKING_UPDAET } from "../apollo/gql/booking";
import {  bookingCancelByHand, bookingCancelByHandVariables, bookingCancelReq, bookingCancelReqVariables, bookingCompleteByHand, bookingCompleteByHandVariables, bookingCreateByHand, bookingCreateByHandVariables, bookingDelete, bookingDeleteVariables, bookingFindByCode, bookingFindByCodeVariables, bookingFindByCode_BookingFindByCode_data, bookingFindByInfo, bookingFindByInfoVariables, bookingFindByInfo_BookingFindByInfo_data, bookingList, bookingListVariables, bookingList_BookingList_data,  bookingsCreate, bookingsCreateVariables, bookingUpdate, bookingUpdateVariables, Fbooking,   PayMethod,   _BookingFilter, _BookingSort } from "../types/api";
...
export const useBookingFindByInfo = generateQueryHook<bookingFindByInfo,bookingFindByInfo_BookingFindByInfo_data[],bookingFindByInfoVariables>(BOOKING_FIND_BY_INFO)
