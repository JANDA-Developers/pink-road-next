...
import { generateFindQuery, generateListQueryHook, generateMutationHook, gnerateQueryHook } from "../utils/query";

export const useCategoryList = gnerateQueryHook<categoryList, categoryList_CategoryList_data[], categoryList_CategoryList_data>(CATEGORY_LIST);
