const info = {
    ...
    pinkVision_title: {
        kr: `핑크로더(PinkRoader)는`,
    },
    pinkVision: {
        kr: `사라져가는 소중한 것들의 가치를 재조명하여, 새로운 라이프 스타일을 창조하는 로컬콘텐츠 컴퍼니 입니다새로운 라이프 스타일을 창조하는 로컬콘텐츠 컴퍼니 입니다`,
    },
    visionBox1_title: { kr: "MISSION" },
    visionBox1_cotnent_new: {
        kr: [
            "우리는 사람과 함께 성장하며 지역에서의 더 나은 일상을 추구합니다.",
        ],
    },
    ...
    value_desc: {
        kr:
            "우리는 사회·지역·사람을 잇는 활동으로 지속가능한 상생의 가치를 만듭니다.",
    },
    ...
    value1_desc: {
        kr: `가까이 있기에 소중함을 모르고 지냈던 우리 지역과 사회의 자원들을
    찾아 발굴 합니다.
    <br className="no" />
    ...
    value2_en: { kr: "fill" },
    value2_desc: {
        kr: `누구나 행복할 수 있는 권리와 능력을 발산 할 수 있는 일의 창출, 지역
