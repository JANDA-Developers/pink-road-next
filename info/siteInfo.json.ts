...
const info:TStieInfo = {
    ...
    컨텐츠 구현을 지향합니다.`},
    visionBox1_title: {kr:"MISSION"},
    visionBox1_cotnent: {kr:`<li >새로운 라이프스타일의 창조(creat new life style)와 공유</li>
        <li >
    ...
    visionBox2_title: {kr:"VISION"},
    visionBox2_cotnent: {kr:`<li>
                                    동남광역권 최고의 공정여행기업
                                </li>
                                <li>
    ...
    value1_desc: {kr:`가까이 있기에 소중함을 모르고 지냈던 우리 지역과 사회의 자원들을
    찾아 발굴 합니다.
    <br className="no" />
    ...
    value2_title: {kr:'채우는'},
    value2_en: {kr:'fill'},
    value2_desc: {kr:`누구나 행복할 수 있는 권리와 능력을 발산 할 수 있는 일의 창출, 지역
    사회공헌 등 상생을 추구합니다. <br className="no" />
    삶의 가치를 모두가 공평히 누릴 수 있도록 취약 계층에 대한 프로그램을
    기획하고 일자리 창출과 매출 대부분을 지역 상권으로 환원해 돌려주는
    공정여행을 기획합니다.`},
    value3_title: {kr:'담아내는'},
    value3_en: {kr:'capture'},
    value3_desc: {kr:`가까이 있기에 소중함을 모르고 지냈던
    ...
    있도록 연구하고 제안합니다.
    `},
    info_img_title: {kr:"공정여행"},
    info_img1_title: {kr:"투어"},
    info_img1_desc: {kr:`수익창출<br />지속가능한 경제`},
    info_img2_title: {kr:"학술"},
    info_img2_desc: {kr:`수익창출<br />지속가능한 경제`},
    info_img3_title: {kr:"투어"},
    info_img3_desc: {kr:`수익창출<br />지속가능한 경제`},
    ...
    <li>(기술평가보증기업)</li>
    <li>여성기업/중소기업 인증</li>`},
    history2019: {kr:`<li>부산공유기업 지정</li>
    <li>부산시 도시재생전문기업 지정</li>
    <li>사회적기업 지정(창의, 혁신)</li>`},
    history2018: {kr:`<li>한국사회적기업 인증</li>
    <li>사회적기업 선정</li>`},
    history2017: {kr:`<li>공정관광네트워크</li>
    <li>부산시관광협회 가입</li>`},
    history2016: {kr:`<li>부산시 예비사회적기업 선정</li>`},
    history2015: {kr:`<li>여행&amp;디자인 통합브랜드</li>
    <li>'부산온나'런칭</li>
    <li>디자인 상품 개발</li>
    <li>부산형 착한기업 선정</li>`},
    history2014: {kr:`<li>주식회사 핑크로더 법인 전환</li>`},
    history2013: {kr:`<li>자체 공정여행 브랜드</li>
    <li>'부산홀릭'런칭&amp;투어운영</li>
