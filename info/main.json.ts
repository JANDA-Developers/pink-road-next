...
const info:TStieInfo = {
    ...
    busi_area1_desc: {kr:`진정성 있고 마음으로 공감할 수 있는
    브랜드 컨텐츠 스토리를 만듭니다.
    ...
    busi_area2_desc: {kr:`지역의 가치있는 문화를 발굴하고 연구
    ...
    busi_area3_desc: {kr:`경제적, 환경적, 사회문화적 지속
    가능성을 모두 충족하는 여행컨텐츠를
    지향합니다. 지역민에게 여행수익이
    ...
    busi_area4_desc: {kr:`경제적, 환경적, 사회문화적 지속
    가능성을 모두 충족하는 여행컨텐츠를
    지향합니다. 지역민에게 여행수익이
    환원될 수 있는 구조로 지역사회 경제에
    직·간접적으로 기여하는 착한여행을
    ...
    bottom_bg_img: {kr:`/img/main_bg_04.jpg`},
}
