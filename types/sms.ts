...
type BOOKING_COOMON = 'BOOKERNMAE' | 'BOOKING_STATUS' | 'TRAVEL_CONFIRMED' | 'TRAVEL_DATE_YMD' | 'PEOPLE' | 'PRICE' | 'PORD_NAME';
export interface REPLACE {
    BANK_TRANSFER_BOOKER: "BOOKERNMAE",
    BANK_TRANSFER_SELLER: 'BOOKERNMAE',
    CALCULATE_REQUEST: 'PARTNERNAME' | "REQUEST_DATE",
    CANCEL_BOOKING_BOOKER: BOOKING_COOMON,
    CANCEL_BOOKING_SELLER: BOOKING_COOMON | 'PARTNERNAME',
    COMPLETE_BOOKING_BOOKER: BOOKING_COOMON,
    COMPLETE_BOOKING_SELLER: BOOKING_COOMON | 'PARTNERNAME',
    PRODUCT_CONFIRM_REQUEST: 'PORD_NAME' | 'PARTNERNAME',
...
const bookingCommon: BOOKING_COOMON[] = ["BOOKERNMAE", "BOOKING_STATUS", "PEOPLE", "PORD_NAME", "PRICE", "TRAVEL_CONFIRMED", "TRAVEL_DATE_YMD"];
