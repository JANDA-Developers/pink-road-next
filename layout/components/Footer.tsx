...
export const Footer: React.FC<IProp> = () => {
    const { isLogin, homepage, isManager } = useContext(AppContext);
            ...
            <div id="gotop" className="">
                ...
                {isLogin && !isManager && (
                    <Link href="/mypage/basket">
                        <a className="basket">
                            <img src="/img/svg/basket.svg" alt="basket icon" />
                            <button />
                        </a>
                    </Link>
                )}
                ...
                <div className="bottom_nav">
                    <div className="mobile__select">
                        <input
                            ...
                            type="checkbox"
                            name="checkbox-set"
                            className="mobile-select-1"
                        />
                        <label
                            htmlFor="mobile-select-1"
                            className="mobile-select-label-1"
                        >
                            <strong>서비스 바로가기</strong>
                            <i className="jandaicon-arr4-bottom"></i>
                        </label>
                        <div
                            className="mobile__select_box"
                            id="mobile-selectbox-1"
                        >
                            <ul>
                                <li className="link">
                                    <a href="/site-info">회사소개</a>
                                </li>
                                <li className="link">
                                    <a href="/member/rule">이용약관</a>
                                </li>
                                <li className="link">
                                    <a href="/member/kr-terms">국내여행약관</a>
                                </li>
                                <li className="link">
                            ...
                            <div>
                                ...
                                {homepage?.twitterLink && (
                                    <a
                                        ...
                                        target="_blank"
                                    >
                                        <i className="jandaicon-twitter"></i>
                                    </a>
                                )}
                                {homepage?.instaLink && (
                                    <a
                                        href={homepage?.instaLink}
                                        target="_blank"
                                    >
                                ...
                                {homepage?.blogLink && (
                                    <a
                                        href={homepage?.blogLink}
                                        target="_blank"
                                    >
                                        <i className="icon_blog"></i>
                                    </a>
                                )}
                            </div>
                        </li>
                ...
                <div className="f_detail_wrap">
                    ...
                    <div className="copyright">
                        <ul className="footer_homepage_info">
                            ...
                            <li className="bottom_txt pc">{copyRight}</li>
                        </ul>
                        <ul className="footer_homepage_info mt">
                            ...
                            <li>
                                <strong>계좌번호</strong>
                                <span>
                                    {bankName} {accountNumber}/예금주:
                                    {accountHolder}
                                </span>
                            </li>
                            <li className="bottom_txt m">{copyRight}</li>
                        </ul>
