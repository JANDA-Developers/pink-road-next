        ...
        <div className="w1200">
          {isLogin ? (
            <p className="welcome_ms">
              ...
              {isManager && <strong>핑크로더</strong>}님 어서오세요
            </p>
          ) : (
            ""
              ...
              <div className="logo">
                <h1>
                  <Link href="/">
                    <a>
                      <img
                        src={homepage?.logoTop?.uri || "/img/logo.png"}
                        alt="logo"
                      />
                    </a>
                  </Link>
            ...
            <div className="hd_center">
              <div className="nav_wrap">
                <ul className="deps1" id="nav-bar">
                  ...
                  <li className="deps">
                    <a
                      href="https://smartstore.naver.com/pinkroader"
                      target="_blank"
                    >
                      Design Goods
                    </a>
                  ...
                  <li className="deps">
                    ...
                    <ul className="deps_nav">
                      <li>
                        <a href={`/news?type=${NEWS_TYPE.TRAVEL}`}>
                          여행이야기
                        </a>
                      </li>
                      <li>
                        <a href={`/news?type=${NEWS_TYPE.CULTURE}`}>
                          문화이야기
                        </a>
                      </li>
                      <li>
                        <a href={`/news?type=${NEWS_TYPE.MEDIA}`}>언론보도</a>
                      </li>
                    </ul>
                  </li>
                </ul>
                ...
                <div className="hidden">
                  <div className="w1200">
                    <div className="search_wrap">
                      <input
                        onKeyPress={whenEnter(goToSearchPage)}
                        value={search}
            ...
            <div id="all_menu">
              ...
              <ul>
                <li className="a_menu_tit deps solo_nav">
                  <Link href="/site-info">
                    <a>
                      PinkRoader<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                </li>
                <li className="a_menu_tit deps solo_nav">
                  <Link href="/portfolio">
                    <a>
                      Work<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                </li>
                <li className="a_menu_tit deps">
                  <Link href="/tour/list">
                    <a>
                      Tour<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                  <ul className="depth1">
                ...
                <li className="a_menu_tit deps">
                  <Link href="/tour?type=exp">
                    <a>
                      Experience<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                  <ul className="depth1">
                    <li onClick={handleAllClose}>
                      <Link href="/tour/list?type=exp">
                        <a>체험 리스트</a>
                      </Link>
                    </li>
                    {isParterNonB && (
                ...
                <li className="a_menu_tit deps solo_nav">
                  <Link href="/">
                    <a target="_blank">
                      Design Goods<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                </li>
                <li className="a_menu_tit deps">
                  <Link href="/news">
                    <a target="_blank">
                      News<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                  <ul className="depth1">
                    <li onClick={handleAllClose}>
                    ...
                    <li onClick={handleAllClose}>
                      <Link href={`/news?type=${NEWS_TYPE.CULTURE}`}>
                        <a>문화이야기</a>
                      </Link>
                    </li>
                    <li onClick={handleAllClose}>
                      <Link href={`/news?type=${NEWS_TYPE.MEDIA}`}>
                        <a>언론보도</a>
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="a_menu_tit deps">
                  <Link href="/login">
                    <a>
                      Member<i className="jandaicon-arr4-right"></i>
                    </a>
                  </Link>
                  <ul className="depth1">
                    {!isLogin && (
                    ...
                    <li>
                      <Link href="/member/rule">
                        <a>이용약관</a>
                      </Link>
                    </li>
                    <li>
                      <Link href="/member/privacy-policy">
                        <a>개인정보처리방침</a>
                      </Link>
                    </li>
                    <li>
                ...
                {isLogin && (
                  <li className="a_menu_tit deps">
                    <Link href="/mypage">
                      <a target="_blank">
                        My page<i className="jandaicon-arr4-right"></i>
                      </a>
                    </Link>
                    <ul className="depth1">
                      <li>
                ...
                {isManager && (
                  <li className="a_menu_tit deps">
                    <Link href="/master">
                      <a>
                        Master<i className="jandaicon-arr4-right"></i>
                      </a>
                    </Link>
                    <ul className="depth1">
                      <li>
