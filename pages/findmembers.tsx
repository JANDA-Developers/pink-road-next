            ...
            <div className="con_box">
                ...
                <span className="info">아이디가 기억나지 않으신가요? 가입 시 입력한 개인 정보로 인증 절차를 거치면 확인이 가능합니다.</span>
                    ...
                    <div className="idfind_box in_box">
                        ...
                        <h4>휴대전화</h4>
                        <div className="input_box"><input type="text" placeholder="가입시 입련한 휴대전화번호를 입력해 주세요." /></div>
                        <div className="certification_sec"><button className="btn">아이디 찾기</button></div>
                    </div>
                </div>
                <div className="right">
                    <h3>비밀번호 찾기</h3>
                    <span>비밀번호가 기억나지 않으신가요? 가입 시 입력한 이메일를 입력 후 가입 시 입력한 휴대전화 번호로 임시 비밀번호가 발급이 됩니다.</span>
                    <div className="pwfind_box in_box">
                        ...
                        <div className="certification_sec">
                            <button className="btn">임시 비밀번호 받기</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <dl>
                    ...
                    <dd>
                        <ul className="bul_list">
                            <li><span className="dot_arr">혹시, 스팸 문자함에 문자가 있는지 확인해 주세요.</span></li>
                            <li><span className="dot_arr">혹시, 핸드폰이 통신 불가능 아닌지 비행기모드가 아닌지 확인해 주세요.</span></li>
                            <li><span className="dot_arr">그래도 찾을 수 없다면 고객센터로 문의 해주세요.</span></li>
                        </ul>
                    </dd>
                </dl>
            </div>
