                ...
                <div className="sign_in w1200">
                    <div className="inner">
                        <div className="login_page">
                            ...
                            <label
                                htmlFor="tab-2"
                                className="tab-label-2 login_tap tap_02"
                            >
                                <b>기업파트너</b>
                            </label>
                            <input
                                ...
                                onChange={() => {
                                    handleUserType(UserRole.partner);
                                }}
                            />
                            <label
                                htmlFor="tab-3"
                                className="tab-label-3 login_tap tap_03"
                            >
                                <b>개인파트너</b>
                            </label>
                            <input
                            ...
                            <label
                                htmlFor="tab-4"
                                className="tab-label-4 login_tap tap_03"
                            >
                                <b>마스터</b>
                            </label>
                            <div className={`login_wrap white_box`}>
                                    ...
                                    <div className="login__snslink2">
                                        <ul>
                                            <li className="login__snslink2_k">
                                                ...
                                                >
                                                    <span className="login__snslink2_icon">
                                                        <i className="jandaicon-kakaotalk"></i>
                                                    </span>
                                                    <span className="login__snslink2_txt">
                                                        카카오톡 로그인
                                                    </span>
                                                </a>
                                            </li>
                                ...
                                {userType === UserRole.individual && (
                                    <div className="reservation__inquiry">
                                        <a href="/member/anonyMemberFindBook">
                                            비회원 예약조회<i className=""></i>
                                        </a>
                                    </div>
                                )}
                            </div>
