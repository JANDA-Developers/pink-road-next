...
const bxlist = () => {
    ...
    const [epage, setEPage] = useState<number>(0);
    ...
    useEffect(() => {
        ...
        if (current_ePage >= (pageNum || 0)) {
            current_ePage = pageNum || 0;
        }
    ...
    const handleNavi = (e: any, naviTarget: number) => {
        e.preventDefault();
