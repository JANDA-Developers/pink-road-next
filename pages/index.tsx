...
export const Main: React.FC<IProp> = () => {
  ...
  return <div className="body main" id="main" >
    ...
    <div className="main_con_box2">
      <div className="w1200">
        <div className="top_txt">
          ...
          <p>목표로 삼고 나아가는 가치있는 생각 3가지</p>
        </div>
        <ul>
          <li>
            <i className="flaticon-diamond"></i>
            <strong>
              지속가능한<br className="no" />
                                공간을 그리다asdas
                            </strong>
            <p>
              sustainable space
          ...
          <li>
            <i className="flaticon-diamond"></i>
            <strong>
              잊히지 않는<br className="no" />
                                시대를 그리다
                            </strong>
            <p>unforgettable period</p>
          </li>
          <li>
            <i className="flaticon-diamond"></i>
            <strong>
              상생하는<br className="no" />
                                사람을 그리다
                            </strong>
            <p>co-prosperity person</p>
      ...
      <div className="w100">
        <div className="top_txt">
          <a href="/tour-list">
            ...
            <p>가치있는 체험</p>
            <i>
              <svg><polygon points="69.22 12.71 0 12.71 0 10.71 64.33 10.71 54.87 1.43 56.27 0 69.22 12.71" /></svg>
            </i>
          </a>
        </div>
        <div className="photo_box">
          <ul className="photo_ul line4">
            ...
            <PhotoLi onClickImg={() => {
            }} id={"12"} key={4 + "photo"} {...DummyPhoto[4]} />
          </ul>
          <ul className="photo_ul line4">
            <PhotoLi onClickImg={() => {
    ...
    <div className="main_con_box5">
      <div className="txt">
        <h2>
          <strong>우리는</strong>새로운 변화속에서 <strong>사회적 가치</strong>를 지키며 서로 <strong>상생</strong>하는 일을 합니다.
                    </h2>
