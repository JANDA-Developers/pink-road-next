...
export const MsIndex: React.FC<IProp> = () => {
    ...
    const {
        items: indiUsers,
        setUniqFilter: setIndiFilter,
        filter: indiUserFilter,
    } = indiUserListHook;
    const {
        items: parterUsers,
                    ...
                    <div className="hang div01">
                        <div className="head">
                            ...
                            <ul className="board_option">
                                <li
                                    onClick={productTypeFilter(
                                        ProductType.TOUR
                                    )}
                                    className={checkOnProductType(
                                        ProductType.TOUR
                                    )}
                                >
                                    <a>
                                        여행<strong>{totalTourCount}</strong>
                                    </a>
                                </li>
                                <li
                                    onClick={productTypeFilter(
                                ...
                                >
                                    <a>
                                        체험<strong>{totalExpCount}</strong>
                                    </a>
                                </li>
                            </ul>
