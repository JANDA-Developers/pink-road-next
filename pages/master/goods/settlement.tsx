...
export const MasterSettlement: React.FC<IProp> = () => {
    const [searchType, setSearchType] =
        useState<TsearchType>("exField__code_eq");
    const {
        items,
        filter,
        setFilter,
    ...
    const { filterEnd, filterStart, hanldeCreateDateChange, setDateKey } =
        useDateFilter({ filter, setFilter });
    const { selectAll, isChecked } = useIdSelecter(
    ...
    const checkOnStatus = (status?: SettlementStatus) =>
                            ...
                            <MasterSearchBar
                                ...
                                Option={
                                    ...
                                    >
                                        ...
                                        <option
                                            value={
                                                "exField__sellerName_eq" as TsearchType
                                            }
                                        >
                                            파트너명
                                        </option>
                                        <option
                                            value={
                                                "exField__sellerNickName_eq" as TsearchType
                                            }
                                        >
                                            파트너 닉네임
                                        </option>
                        ...
                        <div className="master__table">
                            ...
                            {items.map((item, i) => (
                                <div key={item._id} className="tbody">
                                    ...
                                    <div className="t03">
                                        <span className="bank">
                                            ({item.seller.bank_name})<br />
                                            <i className="m_title"> / </i>
                                            {item.seller.account_number}
                                            <br />
                                            <i className="m_title"> / </i>
                                            예금주:{item.seller.name}
                                        </span>
                                    </div>
                                    <div
                                        style={{ minWidth: 300 }}
                                    ...
                                    >
                                        <div className="info goods__info_title">
                                            <span className="ct goods__info_title">
                                                문화
                                            </span>{" "}
                                            ...
                                            <div className="txt">
                                                ...
                                                <span className="men">
                                                    ...
                                                    /소아
                                                    {autoComma(
                                                        item.product.kids_price
                                                    )}
                                                    /유아:
                                                    {autoComma(
                                                        item.product.baby_price
                                                    )}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="t05">
                                        <strong className="total_men">
                                            <i className="m_title">인원:</i>
                                            {item.product.compeltePeopleCnt}명
                                        </strong>
                                        <span className="all_men">
                                            (성인
                                            {
                                                item.product.bookerSummary
                                                    .adultCount
                                            }
                                            /소아
                                            {
                                    ...
                                    <div className="t06">
                                        <strong className="money">
                                            합계금액:{" "}
                                            {autoComma(item.totalPrice)}원
                                        </strong>
                                        <span className="sum01">
                                            수수료 및 공제(-){" "}
                                            {autoComma(item.totalFee)}원
                                        </span>
                                        <span className="sum03">
                                            정산금액:{" "}
                                            {autoComma(item.settlementPrice)}원
                                        </span>
                                    </div>
                                    <div className="t07">
