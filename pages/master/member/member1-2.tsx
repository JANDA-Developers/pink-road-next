                        ...
                        <div className="info_page">
                            <div className="full_div">
                                <h4>취소 및 환불내역<i className="jandaicon-info2 tooltip" data-tip="자세한 예약조회는 '예약관리'메뉴를 이용 해주세요." ></i>
                                    <span className="full_div__right"><strong>11월</strong> - 취소예약<strong> 23건</strong> / 환수<strong className="red_font"> -1,000,000원</strong><a className="btn" href="/master/reservation">예약관리 바로가기</a></span>
                                </h4>
                                <div className="info_table reservationlist">
                                    <div className="tr">
                                        <div className="re01">
...
export default auth(ADMINS)(MsMemberB);