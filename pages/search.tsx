...
export const Search: React.FC<Ipage> = (_pageInfo) => {
  ...
  const {
    items: boards,
    pageInfo: { totalCount: boardTotalCount },
  ...
  const checkOnType = (type: TboardTapType) =>
    boardTapType === type ? "on" : "";

  const getTotalCount = () => {
    return noSearch ? 0 : isProdView ? totalProdCount : boards.length;
  };

  const { paging, setPage: setBoardPage, slice } = generateClientPaging(
    boards,
    viewCount
  );
      ...
      <div className="search_in w1200">
        <div className="con_top">
          ...
          <div className="searchTap">
            <span
              onClick={handleBoardType("board")}
              className={`searchTap__type ${checkOnType("board")}`}
            >
              통합검색
            </span>
            <span
              onClick={handleBoardType("product")}
              className={`searchTap__type ${checkOnType("product")}`}
            >
              상품검색
            </span>
          </div>
                ...
                <div className="jul2">
                  ...
                  <div className="in">
                    <span
                      ...
                      className={`check ${typeOn(undefined)}`}
                    >
                      전체상품
                    </span>
                    <span
                      onClick={handleTypeFilter(ProductType.TOUR)}
                      className={`check ${typeOn(ProductType.TOUR)}`}
                    >
                      여행상품
                    </span>
                    <span
                      onClick={handleTypeFilter(ProductType.EXPERIENCE)}
                      className={`check ${typeOn(ProductType.EXPERIENCE)}`}
                    >
                      체험상품
                    </span>
                  </div>
        ...
        <div className="con_bottom">
          ...
          <div id="ProductViewer" className="con_box">
            <div className="alignment">
              <div className="left_div">
                <h5>
                  QnA<strong>{getTotalCount()}</strong>
                </h5>
              </div>
              <div className="right_div">
                <SortSelect onChange={setSort} sort={sort} />
          ...
          <div id="ProductViewer" className="con_box">
            <div className="alignment">
              <div className="left_div">
                <h5>
                  News<strong>{getTotalCount()}</strong>
                </h5>
              </div>
              <div className="right_div">
                <SortSelect onChange={setSort} sort={sort} />
          ...
          <div id="ProductViewer" className="con_box">
            <div className="alignment">
              <div className="left_div">
                <h5>
                  Portfolio<strong>{getTotalCount()}</strong>
                </h5>
              </div>
              <div className="right_div">
                <SortSelect onChange={setSort} sort={sort} />
          ...
          <div id="ProductViewer" className="con_box">
            <div className="alignment">
              <div className="left_div">
                <h5>
                  Question<strong>{getTotalCount()}</strong>
                </h5>
              </div>
              <div className="right_div">
                <SortSelect onChange={setSort} sort={sort} />
          ...
          <div id="ProductViewer" className="con_box">
            <div className="alignment">
              <div className="left_div">
                <h5>
                  Product<strong>{getTotalCount()}</strong>
                </h5>
              </div>
              <div className="right_div">
                <SortSelect onChange={setSort} sort={sort} />
